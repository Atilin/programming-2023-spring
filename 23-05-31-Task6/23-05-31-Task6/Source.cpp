...
int main()
{
	...
	cout << "ЗАДАЧА 6: ЧИСЛЕННОЕ РЕШЕНИЕ ЗАДАЧИ КОШИ. ВАРИАНТ 8" << endl;
	//cout << tgamma(1);
	...
	while (flag == 1)
	{
		...
		cout << "Абсолютная погрешность для последнего члена Эйлер 1 = " << abs(F(x0 + N * h) - res) << endl << endl;
		...
		cout << "Абсолютная погрешность для последнего члена Эйлер 2 = " << abs(F(x0 + N * h) - res) << endl << endl;
		cout << endl;
